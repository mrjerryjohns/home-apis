...
public object ApplicationBasicTrait {
    ...
    public open class AttributesImpl public constructor(vendorName: kotlin.String? = COMPILED_CODE, vendorId: kotlin.UShort? = COMPILED_CODE, applicationName: kotlin.String? = COMPILED_CODE, productId: kotlin.UShort? = COMPILED_CODE, application: com.google.home.matter.standard.ApplicationBasicTrait.ApplicationStruct? = COMPILED_CODE, status: com.google.home.matter.standard.ApplicationBasicTrait.ApplicationStatusEnum? = COMPILED_CODE, applicationVersion: kotlin.String? = COMPILED_CODE, allowedVendorList: kotlin.collections.List<kotlin.UShort>? = COMPILED_CODE, generatedCommandList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, acceptedCommandList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, attributeList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, featureMap: kotlin.UInt = COMPILED_CODE, clusterRevision: kotlin.UShort = COMPILED_CODE) : com.google.home.matter.standard.ApplicationBasicTrait.Attributes {
        public companion object {
