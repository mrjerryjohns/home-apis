...
public object SmokeCoAlarmTrait {
    ...
    public interface Attributes {
        ...
        public open class AttributesImpl public constructor(expressedState: com.google.home.matter.standard.SmokeCoAlarmTrait.ExpressedStateEnum? = COMPILED_CODE, smokeState: com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, coState: com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, batteryAlert: com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, deviceMuted: com.google.home.matter.standard.SmokeCoAlarmTrait.MuteStateEnum? = COMPILED_CODE, testInProgress: kotlin.Boolean? = COMPILED_CODE, hardwareFaultAlert: kotlin.Boolean? = COMPILED_CODE, endOfServiceAlert: com.google.home.matter.standard.SmokeCoAlarmTrait.EndOfServiceEnum? = COMPILED_CODE, interconnectSmokeAlarm:
        com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, interconnectCoAlarm: com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, contaminationState: com.google.home.matter.standard.SmokeCoAlarmTrait.ContaminationStateEnum? = COMPILED_CODE, smokeSensitivityLevel: com.google.home.matter.standard.SmokeCoAlarmTrait.SensitivityEnum? = COMPILED_CODE, expiryDate: kotlin.UInt? = COMPILED_CODE, generatedCommandList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, acceptedCommandList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, attributeList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, featureMap: com.google.home.matter.standard.SmokeCoAlarmTrait.Feature = COMPILED_CODE, clusterRevision: kotlin.UShort =
        COMPILED_CODE) : com.google.home.matter.standard.SmokeCoAlarmTrait.Attributes, com.google.home.matter.serialization.CanMutate<com.google.home.matter.standard.SmokeCoAlarmTrait.Attributes, com.google.home.matter.standard.SmokeCoAlarmTrait.MutableAttributes> {
        public companion object {
        ...
        public open fun toString(): kotlin.String { /* compiled code */ }
            ...
            com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, interconnectCoAlarm: com.google.home.matter.standard.SmokeCoAlarmTrait.AlarmStateEnum? = COMPILED_CODE, contaminationState: com.google.home.matter.standard.SmokeCoAlarmTrait.ContaminationStateEnum? = COMPILED_CODE, smokeSensitivityLevel: com.google.home.matter.standard.SmokeCoAlarmTrait.SensitivityEnum? = COMPILED_CODE, expiryDate: kotlin.UInt? = COMPILED_CODE, generatedCommandList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, acceptedCommandList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, attributeList: kotlin.collections.List<kotlin.UInt> = COMPILED_CODE, featureMap: com.google.home.matter.standard.SmokeCoAlarmTrait.Feature = COMPILED_CODE, clusterRevision: kotlin.UShort =
            COMPILED_CODE): com.google.home.matter.standard.SmokeCoAlarmTrait.AttributesImpl { /* compiled code */ }
    }
