...
public final class MatterError public constructor(code: kotlin.Int, message: kotlin.String) : com.google.home.BaseHomeError {
    public companion object {
        private final val errorCodeRegex: kotlin.text.Regex /* compiled code */

        private final fun getCodeFromMessage(message: kotlin.String, prefix: kotlin.String = COMPILED_CODE): kotlin.Int { /* compiled code */ }
    }
